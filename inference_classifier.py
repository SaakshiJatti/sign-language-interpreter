...
#     data_aux = np.pad(data_aux, ((0, 0), (0, 219 - data_aux.shape[1])), mode='constant', constant_values=0)
#     # data_aux = [item if len(item) == 219 else np.pad(item, (0, 219 - len(item))) for item in data_aux]  # If needed, pad to 219
#     # data_aux = np.asarray(data_aux)

#     # data_aux = data_aux[:219]
#     # data_aux = np.pad(data_aux, (0, 219 - len(data_aux)), 'constant')
#     # x_ = []
#     # y_ = []
...
#                 data_aux = np.append(data_aux, x)
#                 data_aux = np.append(data_aux, y)
#                 # data_aux.append(x)
#                 # data_aux.append(y)
...
#     #             data_aux = np.append(data_aux, x - min(x_))  # Appends the element to the NumPy array
...
#     cv2.waitKey(25)
# #     print(np.asarray(data_aux).shape)  # Print the shape of data_aux
